    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(max_length=255)),
                ('zipcode', models.CharField(max_length=255)),
                ('max_distance_preferences', models.FloatField(default=0, null=True)),
                ('longitude', models.DecimalField(blank=True, decimal_places=16, max_digits=22, null=True)),
                ('latitude', models.DecimalField(blank=True, decimal_places=16, max_digits=22, null=True)),
                ('group_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='staticInfo.prioritygroup')),
            ],
        ),
    ]
